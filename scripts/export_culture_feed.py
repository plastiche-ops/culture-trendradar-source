...
CULTURE = re.compile(
    r"文学|作家|诗人|小说|散文|诗歌|写作|阅读|读书|出版|书店|书展|文学奖|非遗|非物质文化遗产|"
    r"传承人|传统技艺|传统工艺|民俗|戏曲|曲艺|博物馆|文物|古籍|考古|哲学|历史|人类学|社会学|"
    r"美学|人文|文化遗产|纪录片|文化节目|人文节目"
)
EVENT = re.compile(r"获奖|颁奖|入选|公布|发布|开幕|闭幕|逝世|去世|讣告|争议|抄袭|剽窃|侵权|回应|声明|辟谣|判决|官宣|定档|停播|启动|成立|展览|书展|签售|首发|申遗")
...
def item(
    *, title: str, url: str, source: str, source_type: str, platform: str,
    ...
    return {
        ...
        "institutions": [],
        "places": [],
        "p0": any(name in P0_PEOPLE for name in people) or bool(re.search(r"诺贝尔文学奖|鲁迅文学奖|茅盾文学奖|逝世|去世|讣告", title)),
        "rank": rank,
